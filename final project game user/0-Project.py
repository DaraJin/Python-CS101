...
def create_data_structure(string_input):
    ...
    while string_input:
        ...
        connect_place=string_input.find("connected to ")+len("connected to ")
        ...
        game_place = string_input.find("play ",dot1+1) + len("play ")
...
def add_connection(network, user_A, user_B):
    ...
    if user_B not in network['connection'][user_A]:
        network['connection'][user_A].append(user_B)
    return network
...
# def who_play_game(network,game):
